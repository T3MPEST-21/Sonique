...
const ArtistDetailScreen = () => {
    ...
    const artistTracks = useMemo(() => {
        return libraryTracks.filter(t => (t.artist || 'Unknown Artist') === name);
    }, [libraryTracks, name]);
        ...
        <View style={styles.container}>
            <LinearGradient colors={['#1e1e2e', '#0f0f13']} style={styles.header}>
                ...
                <View style={styles.headerContent}>
                    ...
                    <Text style={styles.trackCount}>{artistTracks.length} Songs</Text>
                </View>
            </LinearGradient>
...
const styles = StyleSheet.create({
    ...
    artContainer: { width: 120, height: 120, borderRadius: 60, backgroundColor: 'rgba(255,255,255,0.05)', justifyContent: 'center', alignItems: 'center', marginBottom: 15 },
    artistName: { color: '#FFF', fontSize: 28, fontWeight: '700', textAlign: 'center' },
